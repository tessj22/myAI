      ...
      <div className="w-full max-w-screen-md space-y-6">
        ...
        <ol className="list-decimal list-inside space-y-4">
          <li className="text-gray-700">
            ...
            accessing and using the AI chatbot ("Natrol Sleep Assistant") created by Tess
          ...
          <li className="text-gray-700">
            ...
            or implied. Tess makes no representations or warranties regarding
          ...
          <li className="text-gray-700">
            ...
            Tess does not guarantee that the Chatbot will be available at all
          ...
          <li className="text-gray-700">
            ...
            the fullest extent permitted by applicable law, Tess shall not be
            ...
            Tess has been advised of the possibility of such damages.
          </li>
          <li className="text-gray-700">
            <span className="font-semibold">
          ...
          <li className="text-gray-700">
            ...
            decisions made based on its output. Tess is not responsible for any
          ...
          <li className="text-gray-700">
            ...
            considered equivalent to public postings, and Tess does not
          ...
          <li className="text-gray-700">
            ...
            indemnify, defend, and hold harmless Tess from any claims,
            liabilities, damages, losses, and expenses, including reasonable
            legal fees, arising from your use of the Chatbot or violation of
            these Terms of Use.
          </li>
          <li className="text-gray-700">
            <span className="font-semibold">Modifications to Terms:</span> Tess
          ...
          <li className="text-gray-700">
            ...
            have any questions or concerns regarding these Terms of Use, sorry :/ This is for a school project!
          </li>
        </ol>
      </div>
    </div>
