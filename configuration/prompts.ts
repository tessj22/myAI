...
If the excerpts given do not contain any information relevant to the user's question, say something along the lines of "While not directly discussed in the documents that ${OWNER_NAME} provided me with, I can try and explain based on my own understanding. Please go to Natrol's website for more information!" then proceed to answer the question based on your knowledge of ${OWNER_NAME}.
